...
| Suites, all green | **677 py** · **156 forge** · **159 terminal** · **31 agent** · glossary **560/560** · GitHub CI 6/6 |
...
canvas states, and `make glossary-check` requires all 560 of its terms to be defined.
