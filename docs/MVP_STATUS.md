...
| Tests / CI | ✅ **677 passed** python + 156 forge + 156 node, 6-job CI green |
...
apps/
  ...
  terminal         Next.js 14 dashboard ("The Terminal") — 11 pages + 29 API routes
...
- **Node: 187 tests** (156 terminal + 31 agent) + `tsc` type-checks.
