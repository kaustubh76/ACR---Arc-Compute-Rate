...
| Terminal | `npm test && next build` | ✅ **136/136 node tests** (14 suites: buy plan · connection ladder · oracle codec · futures codec · edition · glossary · plain-edition coverage · desk phase · futures book · read result · chain constants · price formatting · indexed tape · verified humans) + clean build (10 pages + 26 API routes) |
