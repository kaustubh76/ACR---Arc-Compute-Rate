...
| Python suite | `pytest packages services tests` | ✅ **658 passed** — including 22 anvil-gated on-chain tests that CI now genuinely runs (a node is started in the job) rather than silently skipping |
