...
| Terminal | `npm test && next build` | ✅ **81/81 node tests** (11 suites: buy plan · connection ladder · oracle codec · futures codec · edition · glossary · plain-edition coverage · desk phase · futures book · read result · chain constants) + clean build (8 pages + 16 API routes) |
