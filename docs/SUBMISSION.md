...
| Python suite | `pytest packages services tests` | ✅ **282 passed** — including 9 anvil-gated on-chain tests that CI now genuinely runs (a node is started in the job) rather than silently skipping |
