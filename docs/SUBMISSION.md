...
| Terminal | `npm test && next build` | ✅ **156/156 node tests** (21 suites: buy plan · connection ladder · oracle codec · futures codec · edition · glossary · plain-edition coverage · desk phase · futures book · read result · chain constants · price formatting · indexed tape · verified humans · the agent gate · the agent card · the human proof · the MCP snippet · the reroute decision · the screen verdict · the loop) + clean build (11 pages + 29 API routes) |
