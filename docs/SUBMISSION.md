...
## 5. Verification evidence (each gate dated where it differs; suites re-measured 2026-08-06)
...
re-measured on 2026-08-06; the on-chain ceremonies carry their own dates. The same gates
...
| Terminal | `npm test && next build` | ✅ **93/93 node tests** (12 suites: buy plan · connection ladder · oracle codec · futures codec · edition · glossary · plain-edition coverage · desk phase · futures book · read result · chain constants · price formatting) + clean build (9 pages + 18 API routes) |
