...
`make ci` green 2026-09-12: **661 py** · **156 forge** (incl. futures + invariants) · **136 terminal** · **21/21 agent** · resistance **4/4** · interop **12/12** · glossary **426/426** · GitHub CI **6/6**.
