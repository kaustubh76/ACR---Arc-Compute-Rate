...
`make ci` green 2026-09-07: **535 py** · **156 forge** (incl. futures + invariants) · **106 terminal** · **13/13 agent** · resistance **4/4** · interop **12/12** · glossary **426/426** · GitHub CI **6/6**.
