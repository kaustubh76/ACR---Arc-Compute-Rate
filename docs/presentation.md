...
`make ci` green 2026-09-13: **677 py** · **156 forge** (incl. futures + invariants) · **143 terminal** · **31/31 agent** · resistance **4/4** · interop **12/12** · glossary **560/560** · GitHub CI **6/6**.
