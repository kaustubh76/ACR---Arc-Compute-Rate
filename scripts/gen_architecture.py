...
def build() -> None:
    ...
    card("h_tests", 2260, 1642, 510, 180, "TESTS · 696 py + 156 forge + 165 terminal + 31 agent",
    ...
    card("j_metrics", 2860, 590, 620, 470, "DEMO-DAY METRICS · LIVE ON ARC",
         ["Terminal (Vercel) · Seller API (Render) · chain 5042002",
          ...
          "696 py · 156 forge · 165 terminal · 31 agent — green"], INK, body_size=12)
    ...
    card("t_graph", 650, 2795, 540, 215, "acr-tape SUBGRAPH (The Graph · Studio ethonline v0.2.0)",
         ["7 data sources on arc-testnet · ~3 s behind head",
          ...
          "graph/ · 58 matchstick tests · no Substreams on Arc (stated)"], TEAL, body_size=12)
